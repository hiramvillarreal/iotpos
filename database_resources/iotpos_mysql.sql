...
INSERT INTO iotposdb.measures (id, text) VALUES(1, 'Pc');
#Insert a default client
INSERT INTO iotposdb.clients (id, code, name, points, discount) VALUES (1, '000001', 'General', 0, 0);

#Insert a default department/category/subcategory
-- INSERT INTO iotposdb.categories (catid, text) VALUES (1, 'None'); --This is used as a root category. Used ONLY for pointing to a root category at subcategories.
INSERT INTO iotposdb.categories (catid, text) VALUES (1, 'General');
INSERT INTO iotposdb.departments (id, text) VALUES (1, 'General');
INSERT INTO iotposdb.subcategories (id, text) VALUES (1, 'General');

#Insert default card types (very important to keep these ids)
INSERT INTO iotposdb.cardtypes (typeid, text) VALUES(1, 'None');
INSERT INTO iotposdb.cardtypes (typeid, text) VALUES(2, 'Credit VISA');
INSERT INTO iotposdb.cardtypes (typeid, text) VALUES(3, 'Credit MC');
INSERT INTO iotposdb.cardtypes (typeid, text) VALUES(4, 'Debit VISA');
INSERT INTO iotposdb.cardtypes (typeid, text) VALUES(5, 'Debit MC');
#Insert default payment types (very important to keep these ids)
INSERT INTO iotposdb.paytypes (typeid, text) VALUES(1, 'Cash');
INSERT INTO iotposdb.paytypes (typeid, text) VALUES(2, 'Card');
INSERT INTO iotposdb.paytypes (typeid, text) VALUES(3, 'Internal Credit');
#Insert default transactions states (very important to keep these ids)
INSERT INTO iotposdb.transactionstates (stateid, text) VALUES(1, 'Not Completed');
INSERT INTO iotposdb.transactionstates (stateid, text) VALUES(2, 'Completed');
INSERT INTO iotposdb.transactionstates (stateid, text) VALUES(3, 'Cancelled');
INSERT INTO iotposdb.transactionstates (stateid, text) VALUES(4, 'PO Pending');
INSERT INTO iotposdb.transactionstates (stateid, text) VALUES(5, 'PO Completed');
INSERT INTO iotposdb.transactionstates (stateid, text) VALUES(6, 'PO Incomplete');
INSERT INTO iotposdb.transactionstates (stateid, text) VALUES(7, 'Reservation');
INSERT INTO iotposdb.transactionstates (stateid, text) VALUES(8, 'Internal Credit');
INSERT INTO iotposdb.transactionstates (stateid, text) VALUES(9, 'Internal Credit');

#Insert default transactions types (very important to keep these ids)
INSERT INTO iotposdb.transactiontypes (ttypeid, text) VALUES(1, 'Sell');
INSERT INTO iotposdb.transactiontypes (ttypeid, text) VALUES(2, 'Purchase');
INSERT INTO iotposdb.transactiontypes (ttypeid, text) VALUES(3, 'Change');
INSERT INTO iotposdb.transactiontypes (ttypeid, text) VALUES(4, 'Return');
#Insert default cashFLOW types
INSERT INTO iotposdb.cashflowtypes (typeid, text) VALUES(1, 'Normal cash OUT');
INSERT INTO iotposdb.cashflowtypes (typeid, text) VALUES(2, 'Money return on ticket cancel');
INSERT INTO iotposdb.cashflowtypes (typeid, text) VALUES(3, 'Money return on product return');
INSERT INTO iotposdb.cashflowtypes (typeid, text) VALUES(4, 'Normal Cash IN');
INSERT INTO iotposdb.cashflowtypes (typeid, text) VALUES(5, 'Cash IN Reservation');
INSERT INTO iotposdb.cashflowtypes (typeid, text) VALUES(6, 'Cash OUT Reservation');
INSERT INTO iotposdb.cashflowtypes (typeid, text) VALUES(7, 'Cash IN Credit Payment');
INSERT INTO iotposdb.cashflowtypes (typeid, text) VALUES(8, 'Cash IN Debit');

#Insert default provider
INSERT INTO iotposdb.providers (id,name,address,phone,cellphone) VALUES(1,'No provider', '-NA-', '-NA-', '-NA-');

INSERT INTO iotposdb.so_status (id, text) VALUES(0, 'Pending');
INSERT INTO iotposdb.so_status (id, text) VALUES(1, 'In Progress');
INSERT INTO iotposdb.so_status (id, text) VALUES(2, 'Ready');
INSERT INTO iotposdb.so_status (id, text) VALUES(3, 'Delivered');
INSERT INTO iotposdb.so_status (id, text) VALUES(4, 'Cancelled');

INSERT INTO iotposdb.bool_values (id, text) VALUES(0, 'NO');
INSERT INTO iotposdb.bool_values (id, text) VALUES(1, 'YES');
...
INSERT INTO iotposdb.taxmodels (modelid,tname,elementsid) VALUES(2,"General","2");
INSERT INTO iotposdb.taxelements (elementid, ename, rate) VALUES (2,"IVA", 16);

INSERT INTO iotposdb.taxmodels (modelid,tname,elementsid) VALUES(3,"Cigarros", "2,3");
INSERT INTO iotposdb.taxelements (elementid, ename, rate) VALUES (3,"Impuesto al tabaco", 5);

INSERT INTO iotposdb.taxmodels (modelid,tname,elementsid) VALUES(4,"Comunicaciones","3,4");
INSERT INTO iotposdb.taxelements (elementid, ename, rate) VALUES (4,"Impuesto a las comunicaciones", 2);
