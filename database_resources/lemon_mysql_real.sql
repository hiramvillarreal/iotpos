...
GRANT ALL ON lemon_real.* TO 'lemonclient'@'localhost' IDENTIFIED BY 'xarwit0721';


# CREATE lemon users (users using lemon, cashiers... )
#With password 'linux'. Note that this password is salt-hashed (SHA56).

INSERT INTO lemon_real.users (id, username, password, salt, name, role) VALUES (1, 'admin', 'C07B1E799DC80B95060391DDF92B3C7EF6EECDCB', 'h60VK', 'Administrator', 2);

##You may change the string values for the next fields


#Insert a default measure (very important to keep this id)
INSERT INTO lemon_real.measures (id, text) VALUES(1, 'Pc');
#Insert a default client
INSERT INTO lemon_real.clients (id, code, name, points, discount) VALUES (1, '000001', 'General', 0, 0);

#Insert a default department/category/subcategory
-- INSERT INTO lemon_real.categories (catid, text) VALUES (1, 'None'); --This is used as a root category. Used ONLY for pointing to a root category at subcategories.
INSERT INTO lemon_real.categories (catid, text) VALUES (1, 'General');
INSERT INTO lemon_real.departments (id, text) VALUES (1, 'General');
INSERT INTO lemon_real.subcategories (id, text) VALUES (1, 'General');

#Insert default card types (very important to keep these ids)
INSERT INTO lemon_real.cardtypes (typeid, text) VALUES(1, 'None');
INSERT INTO lemon_real.cardtypes (typeid, text) VALUES(2, 'Credit VISA');
INSERT INTO lemon_real.cardtypes (typeid, text) VALUES(3, 'Credit MC');
INSERT INTO lemon_real.cardtypes (typeid, text) VALUES(4, 'Debit VISA');
INSERT INTO lemon_real.cardtypes (typeid, text) VALUES(5, 'Debit MC');
#Insert default payment types (very important to keep these ids)
INSERT INTO lemon_real.paytypes (typeid, text) VALUES(1, 'Cash');
INSERT INTO lemon_real.paytypes (typeid, text) VALUES(2, 'Card');
INSERT INTO lemon_real.paytypes (typeid, text) VALUES(3, 'Internal Credit');
#Insert default transactions states (very important to keep these ids)
INSERT INTO lemon_real.transactionstates (stateid, text) VALUES(1, 'Not Completed');
INSERT INTO lemon_real.transactionstates (stateid, text) VALUES(2, 'Completed');
INSERT INTO lemon_real.transactionstates (stateid, text) VALUES(3, 'Cancelled');
INSERT INTO lemon_real.transactionstates (stateid, text) VALUES(4, 'PO Pending');
INSERT INTO lemon_real.transactionstates (stateid, text) VALUES(5, 'PO Completed');
INSERT INTO lemon_real.transactionstates (stateid, text) VALUES(6, 'PO Incomplete');
INSERT INTO lemon_real.transactionstates (stateid, text) VALUES(7, 'Reservation');
INSERT INTO lemon_real.transactionstates (stateid, text) VALUES(8, 'Internal Credit');
INSERT INTO lemon_real.transactionstates (stateid, text) VALUES(9, 'Internal Credit');

#Insert default transactions types (very important to keep these ids)
INSERT INTO lemon_real.transactiontypes (ttypeid, text) VALUES(1, 'Sell');
INSERT INTO lemon_real.transactiontypes (ttypeid, text) VALUES(2, 'Purchase');
INSERT INTO lemon_real.transactiontypes (ttypeid, text) VALUES(3, 'Change');
INSERT INTO lemon_real.transactiontypes (ttypeid, text) VALUES(4, 'Return');
#Insert default cashFLOW types
INSERT INTO lemon_real.cashflowtypes (typeid, text) VALUES(1, 'Normal cash OUT');
INSERT INTO lemon_real.cashflowtypes (typeid, text) VALUES(2, 'Money return on ticket cancel');
INSERT INTO lemon_real.cashflowtypes (typeid, text) VALUES(3, 'Money return on product return');
INSERT INTO lemon_real.cashflowtypes (typeid, text) VALUES(4, 'Normal Cash IN');
INSERT INTO lemon_real.cashflowtypes (typeid, text) VALUES(5, 'Cash IN Reservation');
INSERT INTO lemon_real.cashflowtypes (typeid, text) VALUES(6, 'Cash OUT Reservation');
INSERT INTO lemon_real.cashflowtypes (typeid, text) VALUES(7, 'Cash IN Credit Payment');
INSERT INTO lemon_real.cashflowtypes (typeid, text) VALUES(8, 'Cash IN Debit');

#Insert default provider
INSERT INTO lemon_real.providers (id,name,address,phone,cellphone) VALUES(1,'No provider', '-NA-', '-NA-', '-NA-');

INSERT INTO lemon_real.so_status (id, text) VALUES(0, 'Pending');
INSERT INTO lemon_real.so_status (id, text) VALUES(1, 'In Progress');
INSERT INTO lemon_real.so_status (id, text) VALUES(2, 'Ready');
INSERT INTO lemon_real.so_status (id, text) VALUES(3, 'Delivered');
INSERT INTO lemon_real.so_status (id, text) VALUES(4, 'Cancelled');

INSERT INTO lemon_real.bool_values (id, text) VALUES(0, 'NO');
INSERT INTO lemon_real.bool_values (id, text) VALUES(1, 'YES');

INSERT INTO lemon_real.config (firstrun, taxIsIncludedInPrice, storeLogo, storeName, storeAddress, storePhone, logoOnTop, useCUPS, smallPrint, db_version) VALUES ('yes, it is February 6 1978', true, '', '', '', '', true, true, true, '0950');
...
INSERT INTO lemon_real.taxmodels (modelid,tname,elementsid) VALUES(1,"Exento", "1");
INSERT INTO lemon_real.taxelements (elementid, ename, rate) VALUES (1,"Exento de impuestos", 0);

INSERT INTO lemon_real.taxmodels (modelid,tname,elementsid) VALUES(2,"General","2");
INSERT INTO lemon_real.taxelements (elementid, ename, rate) VALUES (2,"IVA", 16);

INSERT INTO lemon_real.taxmodels (modelid,tname,elementsid) VALUES(3,"Cigarros", "2,3");
INSERT INTO lemon_real.taxelements (elementid, ename, rate) VALUES (3,"Impuesto al tabaco", 5);

INSERT INTO lemon_real.taxmodels (modelid,tname,elementsid) VALUES(4,"Comunicaciones","3,4");
INSERT INTO lemon_real.taxelements (elementid, ename, rate) VALUES (4,"Impuesto a las comunicaciones", 2);
