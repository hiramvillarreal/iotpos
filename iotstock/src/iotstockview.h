...
#ifndef IOTSTOCKVIEW_H
#define IOTSTOCKVIEW_H

#include <QWidget>
#include <QtSql>

#include "ui_iotstockview_base.h"
...
/**
 * This is the main view class for iotstock.  Most of the non-menu,
 ...
 */
class iotstockView : public QWidget, public Ui::iotstockview_base
{
    Q_OBJECT
public:
    iotstockView(QWidget *parent);
    virtual ~iotstockView();
  ...
  private:
    QTimer *rmTimer;
    Ui::iotstockview_base ui_mainview;
    QString activeDb;
    QSqlDatabase db;
    bool adminIsLogged;
